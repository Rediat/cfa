...
def classification(phraselength,percent=1):
	...
	classprob = copy.deepcopy(mylang)	
	...
	l.overallmyclassifier(testing,frequencyTable,grams,overallwrongsCFA,overalltotal,overallrecallCFA,classprob,overallwrongsNBC,overallrecallNBC)
